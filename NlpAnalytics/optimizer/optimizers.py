...
# local
from ..models.model_parameters_analyzer import (ModelParameterAnalyze, BertParamType)
from peft import LoraConfig, get_peft_model, PeftModel
### functors to fine-tune BERT + Classifier



# bert embedding and encpder freezing - 
def parameter_freezing_layers(model : nn.Module, layer_freeze:Optional[dict] = {'embeddings':True,'encoder':None}):
...
class AdamNLP(AdamW):
    ...
    @classmethod
    def newNLPAdam(cls, model: nn.Module, layer_freeze: Optional[dict]={'embeddings': True, 'encoder': None},
        ...
        param_analyzer = ModelParameterAnalyze(model)

        # grouped parameters
        param_with_decay = {'params' : list(), 'weight_decay' : weight_decay}
        param_wo_decay = {'params' : list(), 'weight_decay_rate' : 0.0}
