...
# Summary:
#   A handy toolkit of nlp pre-processs(ref: https://towardsdatascience.com/cleaning-preprocessing-text-data-by-building-nlp-pipeline-853148add68a)
# Remark: it's heavily rely on nltk 
# Remark: alternatively, stanza (https://stanfordnlp.github.io/stanza/) seems to provide an robust nlp tokenization pipeline
...
def removing_stopwords(text, stop_list=STOP_LIST):
   ...
   """
    ...
    No_StopWords = [word for word in word_tokenize(text) if word.lower() not in stop_list]
    # Convert list of tokens_without_stopwords to String type.
    words_string = ' '.join(No_StopWords)    
    return words_string

# Spelling corrections
def spelling_correction(text, spell=SPELL):
    ''' 
...
def lemmatization(text, w_tokenizer=TOKENIZER, lemmatizer=LEMMATIZER):
